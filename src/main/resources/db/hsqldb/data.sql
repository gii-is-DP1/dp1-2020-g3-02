...
INSERT INTO estadisticas_personal_partido(id,saques_acertados,saques_totales,porcentaje_saques,recepciones_acertadas,recepciones_totales,porcentaje_recepciones,jugador_id,partido_id) VALUES (1,10,20,0.5,10,20,0.5,1,1);
INSERT INTO estadisticas_personal_partido(id,saques_acertados,saques_totales,porcentaje_saques,recepciones_acertadas,recepciones_totales,porcentaje_recepciones,jugador_id,partido_id) VALUES (2,12,18,0.6,10,20,0.5,1,2); 
INSERT INTO estadisticas_personal_partido(id,saques_acertados,saques_totales,porcentaje_saques,recepciones_acertadas,recepciones_totales,porcentaje_recepciones,jugador_id,partido_id) VALUES (3,14,22,0.7,10,20,0.5,1,3);
INSERT INTO estadisticas_personal_partido(id,saques_acertados,saques_totales,porcentaje_saques,recepciones_acertadas,recepciones_totales,porcentaje_recepciones,jugador_id,partido_id) VALUES (4,10,25,0.4,10,20,0.5,1,4);
INSERT INTO estadisticas_personal_partido(id,saques_acertados,saques_totales,porcentaje_saques,recepciones_acertadas,recepciones_totales,porcentaje_recepciones,jugador_id,partido_id) VALUES (5,12,14,0.7,10,20,0.5,1,5); 
INSERT INTO estadisticas_personal_partido(id,saques_acertados,saques_totales,porcentaje_saques,recepciones_acertadas,recepciones_totales,porcentaje_recepciones,jugador_id,partido_id) VALUES (6,14,22,0.63,10,20,0.5,1,6); 
